...
if (dcg_main_debug isEqualTo 1) then {
	[{
		...
		["dcg_mission",["Enemy Count: %1, Civilian Count: %2, Group Count: %3, Server FPS: %4, Mission Uptime: %5",_allEnemy,_allCiv,_allGrp,round diag_fps,time]] call dcg_main_fnc_log;
