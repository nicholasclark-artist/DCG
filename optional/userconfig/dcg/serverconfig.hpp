...
class dcg_main_cache {
    typeName = "BOOL";
    typeDetail = "";
    value = 1;
};
class dcg_main_cleanup {
    typeName = "BOOL";
    typeDetail = "";
    value = 1;
};
...
class dcg_occupy_infCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 40;
};
class dcg_occupy_vehCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 2;
};
class dcg_occupy_airCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 1;
};
class dcg_occupy_sniperCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 4;
};
class dcg_occupy_staticCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 3;
};
class dcg_occupy_cityMultiplier {
    typeName = "SCALAR";
    typeDetail = "";
    value = 0.5;
};
class dcg_occupy_townMultiplier {
    typeName = "SCALAR";
    typeDetail = "";
    value = 0.25;
};
...
class dcg_patrol_interval {
    typeName = "SCALAR";
    typeDetail = "";
    value = 600;
};
class dcg_patrol_groupsDynamicMaxCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 10;
};
...
class dcg_civilian_count {
    typeName = "SCALAR";
    typeDetail = "";
    value = 15;
};
class dcg_civilian_vehCount {
    typeName = "SCALAR";
    typeDetail = "";
    value = 2;
};
class dcg_civilian_cityMultiplier {
    typeName = "SCALAR";
    typeDetail = "";
    value = 0.5;
};
class dcg_civilian_townMultiplier {
    typeName = "SCALAR";
    typeDetail = "";
    value = 0.25;
};
